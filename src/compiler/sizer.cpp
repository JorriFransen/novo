...
// bool size_statement(Instance *inst, Task *task, AST_Statement *stmt, Scope *scope)
// {
// }

// bool size_expression(Instance *inst, Task *task, AST_Expression *expr, Scope *scope)
// {
// }
