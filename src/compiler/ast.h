...
enum AST_Declaration_Flag : AST_Declaration_Flags
{
    ...
    AST_DECL_FLAG_PARAMETER_STORAGE_REQUIRED = 0x010,
...
NAPI AST_Declaration* ast_enum_member_declaration(Instance* inst, AST_Identifier* ident, AST_Expression* value_expr);
...
NAPI AST_Expression* ast_alignof_expression(Instance* inst, AST_Expression* operand);
NAPI AST_Expression* ast_offsetof_expression(Instance* inst, AST_Identifier* struct_ident, AST_Identifier* member_ident);
