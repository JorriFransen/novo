...
NAPI bool ssa_find_alloc(SSA_Builder* builder, AST_Node* node, SSA_Register_Handle* result);
NAPI bool ssa_find_alloc(SSA_Builder* builder, AST_Declaration* decl, SSA_Register_Handle* result);
NAPI bool ssa_find_alloc(SSA_Builder* builder, AST_Expression* expr, SSA_Register_Handle* result);
...
NAPI SSA_Register_Handle ssa_emit_lvalue(SSA_Builder* builder, AST_Expression* lvalue_expr, Scope* scope);
NAPI SSA_Register_Handle ssa_emit_expression(SSA_Builder* builder, AST_Expression* expr, Scope* scope);

NAPI SSA_Register_Handle ssa_emit_global_pointer(SSA_Builder *builder, u32 global_index);
NAPI SSA_Register_Handle ssa_emit_bitcast(SSA_Builder* builder, Type* from_type, Type* to_type, SSA_Register_Handle operand_reg);
NAPI SSA_Register_Handle ssa_emit_trunc(SSA_Builder* builder, Type* target_type, SSA_Register_Handle operand_reg);
NAPI SSA_Register_Handle ssa_emit_sext(SSA_Builder* builder, Type* target_type, s64 source_bit_size, SSA_Register_Handle operand_reg);
NAPI SSA_Register_Handle ssa_emit_zext(SSA_Builder* builder, Type* target_type, SSA_Register_Handle operand_reg);
NAPI SSA_Register_Handle ssa_emit_alloc(SSA_Builder* builder, Type* type);
NAPI void ssa_emit_memcpy(SSA_Builder* builder, SSA_Register_Handle dest_ptr_reg, SSA_Register_Handle src_ptr_reg, s64 bit_size);
...
NAPI void ssa_emit_jmp_if(SSA_Builder* builder, SSA_Register_Handle cond_reg, u32 true_block, u32 false_block);
NAPI void ssa_emit_jmp(SSA_Builder* builder, u32 block);

NAPI SSA_Register_Handle ssa_emit_cast(SSA_Builder* builder, Type* from_type, Type* to_type, SSA_Register_Handle operand_reg);
NAPI SSA_Register_Handle ssa_emit_integer_integer_cast(SSA_Builder* builder, Type* from_type, Type* to_type, SSA_Register_Handle operand_reg);

NAPI u32 ssa_emit_op(SSA_Builder* builder, SSA_Op op);
NAPI void ssa_emit_reg(SSA_Builder* builder, SSA_Register_Handle reg_handle);
...
NAPI SSA_Register_Handle ssa_emit_load_constant_value(SSA_Builder* builder, AST_Expression* expr, Scope* scope);
...
NAPI void ssa_emit_constant_integer(SSA_Program* program, DArray<u8> *bytes, Type* type, u64 value);
