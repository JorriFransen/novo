...
#include <string.h>
    ...
    typedef struct
    {
        ...
        wchar_t* vs_exe_path;
        wchar_t* vs_tools_path;
        wchar_t* vs_library_path;
    } MC_Find_Result;

    MC_Find_Result find_visual_studio_and_windows_sdk();
    void free_resources(MC_Find_Result* result);
...
#define concat4(a, b, c, d) concat(a, b, c, d)
    ...
    void find_windows_kit_root(MC_Find_Result* result) {
    ...
    void find_visual_studio_by_fighting_through_microsoft_craziness(MC_Find_Result* result) {
